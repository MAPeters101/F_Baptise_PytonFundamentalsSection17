...
print(list(filter(lambda rec: (rec[2] - rec[4])/rec[2] > .1, quotes)))

def more_than(threshold):
    def predicate(t):
        return (t[2] - t[4]) / t[2] > threshold
    return predicate


print(list(filter(more_than(0.1), quotes)))
print(list(filter(more_than(0.05), quotes)))
print(list(filter(more_than(0.01), quotes)))
